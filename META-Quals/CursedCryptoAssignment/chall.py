...
class RSA:
    ...
    def encrypt(self, m: bytes , e: int) -> list:
        """
        Encrypt the message using the specified public exponent and padding characters.
        """
    ...
    def split_blocks(self, m: bytes, Block_Size: int) -> list:
        ...
        Splitting starts in the opposite direction of regular splitting (from right to left)
        """
        blocks = []
    ...
    def pad_block(self, block: bytes) -> list:
        """
        Pad the block with the specified padding characters.
        """
...
with open('/home/l0mb4rd/CTFs/writing/META-Quals/LP/out.txt', 'w') as f:
    f.write(f'N = {rsa.N}\n')
    f.write(f'c1 = {cts1}\n')
    f.write(f'c2 = {cts2}\n')
    f.write(f'e1 = {e1}\n')
